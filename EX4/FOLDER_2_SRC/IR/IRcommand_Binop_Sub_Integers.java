...
public class IRcommand_Binop_Sub_Integers extends IRcommand
{
	...
	public void MIPSme()
	{
		...
		/********************************************************/
		sir_MIPS_a_lot.getInstance().blt(intMax,t1_minus_t2,label_overflow); // overflow when intMax < t1_minus_t2
		sir_MIPS_a_lot.getInstance().bgt(intMin,t1_minus_t2,label_overflow__min); // overflow when intMin > t1_minus_t2
		sir_MIPS_a_lot.getInstance().bge(intMax,t1_minus_t2,label_no_overflow); // no overflow when inMax >= t1_minus_t2
		...
		sir_MIPS_a_lot.getInstance().move(dst,t1_minus_t2);
		sir_MIPS_a_lot.getInstance().jump(label_end);
